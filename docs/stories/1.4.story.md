...
- [ ] **Task 5: Add OpenAPI documentation** (AC6)
  - [ ] Install Hono OpenAPI/Swagger middleware
  - [ ] Document all endpoints with schemas
  - [ ] Expose `/docs` route for Swagger UI
...
- Task 5: OpenAPI non implémenté (peut être ajouté plus tard)
...
- `backend/src/index.ts` - Import et montage routes farms
- `backend/src/dev-server.ts` - Import et montage routes farms
