# Référentiel B2: API REST

## Livrable: E4 : API REST 
...
#### Critères d'évaluation
Les requêtes de type SQL pour la collecte de données sont fonctionnelles : les données visées sont effectivement extraites suites
...
La documentation technique coure les règles d'authentification et/ou d'autorisation de l'API
